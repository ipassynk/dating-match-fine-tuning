...
def generate_dating_pairs(core_domain, positive_actions, negative_actions):
    core_domain_values = [{"category": "values", "value": value} for value in core_domain["values"]]



    core_domain_dealbreakers = core_domain["dealbreakers"]
    core_domain_lifestyle = core_domain["lifestyle"]
    core_domain_interests = core_domain["interests"]
    core_domain_activities = core_domain["activities"]

    alllist = [core_domain_values]
                     ...
                     dating_pairs.append(InstructionalPair(Gender.MALE, 
                        ...
                        category2="dealbreakers",
                        categoryValue2=dealbreaker)
