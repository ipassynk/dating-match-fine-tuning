...
def generate_dating_pairs(core_domain, positive_actions, negative_actions):
    ...
    for i in range(10):
        ...
        dating_pairs.append(InstructionalPair(Label.SIMPLE_COMPATIBLE,Gender.MALE, 
            positive_actions[random.randint(0, len(positive_actions) - 1)], 
            choice1["category"], choice1["value"], 
            Gender.FEMALE, 
            positive_actions[random.randint(0, len(negative_actions) - 1)], choice2["category"], choice2["value"]))
    ...
    for i in range(10):
        ...
        dating_pairs.append(InstructionalPair(Gender.MALE, 
            ...
            negative_actions[random.randint(0, len(positive_actions) - 1)], choice1["category"], choice1["value"]))
